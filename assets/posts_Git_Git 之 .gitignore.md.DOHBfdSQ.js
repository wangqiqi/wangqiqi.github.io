...
<span class="line"><span>doc/**/*.pdf</span></span></code></pre></div><ol start="3"><li>要养成一个好的习惯 每次建立新仓库的时候，应及时建立 <code>.gitignore</code> 文件，以免将来提交无用的文件。</li></ol><blockquote><p><code>Git </code> 除了利用 <code>.gitignore</code> 方式忽略不需要跟踪的文件外。还提供了另外一种方式 <code>exclude</code>, <code>exclude</code> 存放在 <code>.git/info/exclude </code> ， 它与 <code>.gitignore</code> 不同的是， <code>exclude</code> 是本地需要排除的文件，不会提交到仓库中应用在别人机器上，而 <code>.gitignore</code> 本身可以提交到仓库中，适用于使用仓库的所有人。</p></blockquote><blockquote><p><code>.gitignore</code> 文件可以作为占位文件，例如有些文件夹需要同步到仓库中，可以在文件夹中新建一个 <code>.gitignore </code>文件，下次拉取的时候可以同步拉取了这个空目录。</p></blockquote><ol start="4"><li>如果已经提交了大文件到仓库中， 怎么办？ <strong>思考中，下集再见</strong></li></ol><h2 id="【示例】" tabindex="-1">【示例】 <a class="header-anchor" href="#【示例】" aria-label="Permalink to “【示例】”">​</a></h2><p><a href="https://github.com/github/gitignore" target="_blank" rel="noreferrer"><code>.gitignore</code> 模板文件</a></p><p><code>c++/cuda</code> 项目下的 <code>.gitignore</code> 文件模板</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># Prerequisites</span></span>
...
<span class="line"><span>*.fatbin</span></span></code></pre></div><p><code>c </code>项目下的 <code>.gitignore</code> 文件模板</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># Prerequisites</span></span>
<span class="line"><span>*.d</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>dkms.conf</span></span></code></pre></div><p><code>Python </code>项目下的 <code>.gitignore</code> 文件模板</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># Byte-compiled / optimized / DLL files</span></span>
...
<span class="line"><span>#.idea/</span></span></code></pre></div><h2 id="【参考】" tabindex="-1">【参考】 <a class="header-anchor" href="#【参考】" aria-label="Permalink to “【参考】”">​</a></h2><ol><li><a href="https://www.cnblogs.com/pylemon/archive/2012/07/16/2593112.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/pylemon/archive/2012/07/16/2593112.html</a></li><li><a href="https://github.com/github/gitignore" target="_blank" rel="noreferrer">https://github.com/github/gitignore</a></li><li><a href="https://blog.csdn.net/ThinkWon/article/details/101447866" target="_blank" rel="noreferrer">https://blog.csdn.net/ThinkWon/article/details/101447866</a></li></ol>`,22)]])}var s=e(a,[[`render`,o]]);export{i as __pageData,s as default};