import{_ as a,c as n,o as i,ag as p}from"./chunks/framework.B-XtCDNB.js";const e="/assets/image.lZuwCfNp.png",u=JSON.parse('{"title":"Windows10 YOLOv8运行报错","description":"","frontmatter":{"title":"Windows10 YOLOv8运行报错","date":"2025-01-01T16:55:29.000Z","categories":["Windows","Pytorch","运维"],"tags":["Pytorch","Windows","Yolov8"]},"headers":[],"relativePath":"posts/Windows/Windows10-YOLOv8运行报错.md","filePath":"posts/Windows/Windows10-YOLOv8运行报错.md","lastUpdated":1759744117000}'),t={name:"posts/Windows/Windows10-YOLOv8运行报错.md"};function l(o,s,r,c,h,d){return i(),n("div",null,[...s[0]||(s[0]=[p(`<p>问题如下：</p><p>Windows10 运行 YOLOv8 出现如下错误：</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Traceback (most recent call last):</span></span>
