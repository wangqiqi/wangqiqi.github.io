import{_ as a,c as n,o as i,a5 as p,aK as e}from"./chunks/framework.BB9qmTK0.js";const u=JSON.parse('{"title":"Windows10 YOLOv8运行报错","description":"","frontmatter":{"title":"Windows10 YOLOv8运行报错","date":"2025-01-01T16:55:29.000Z","categories":["Windows","Pytorch","运维"],"tags":["Pytorch","Windows","Yolov8"]},"headers":[],"relativePath":"posts/Windows/Windows10-YOLOv8运行报错.md","filePath":"posts/Windows/Windows10-YOLOv8运行报错.md","lastUpdated":1759744117000}'),t={name:"posts/Windows/Windows10-YOLOv8运行报错.md"};function l(o,s,r,h,c,d){return i(),n("div",null,[...s[0]||(s[0]=[p(`<p>问题如下：</p><p>Windows10 运行 YOLOv8 出现如下错误：</p><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>Traceback (most recent call last):</span></span>
...
<span class="line"><span>        is not going to be frozen to produce an executable.</span></span></code></pre></div><p>修改<br><code>D:\\anaconda3\\envs\\yolov8\\Lib\\site-packages\\ultralytics\\data</code> 路径下的 <code>build.py</code> 文件里的函数 <code>build_dataloader</code>，将：</p><div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">nw </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> min</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">([os.cpu_count() </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">//</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> max</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(nd, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">), batch </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">if</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> batch </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 1</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> else</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, workers])  </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># number of workers</span></span></code></pre></div><p>直接修改为：</p><div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">nw </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # update by jw 20230815</span></span></code></pre></div><p>完整函数示例如下：</p><div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">def</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> build_dataloader</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(dataset, batch, workers, shuffle</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">True</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, rank</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=-</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">):</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # ... 后续代码保持不变</span></span></code></pre></div><p><img src="`+e+'" alt="错误示意图"></p><h2 id="【参考】" tabindex="-1">【参考】 <a class="header-anchor" href="#【参考】" aria-label="Permalink to “【参考】”">​</a></h2><ul><li><a href="https://zhuanlan.zhihu.com/p/553407062#:~:text=RuntimeError%3A%20An%20attempt%20has%20been%20made%20to%20start,main%20module%3A%20if%20__name__%20%3D%3D%20%27__main__%27%3A%20freeze_support%20%28%29" target="_blank" rel="noreferrer">解决 RuntimeError: An attempt has been made to start a new process before... 办法</a></li><li><a href="https://www.cnblogs.com/carmen-019/p/15077749.html" target="_blank" rel="noreferrer">Python 进程 - 调试报错 you are not using fork to start your child processes</a></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span></span></span></code></pre></div>',13)])])}const g=a(t,[["render",l]]);export{u as __pageData,g as default};
